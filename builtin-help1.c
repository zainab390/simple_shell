...
/**
 * help_alias - Displays information on the shellby builtin cmd 'alias'.
 */
void help_alias(void)
{
...
/**
 * help_cd - Displays information on the shellby builtin cmd 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit - Displays info on the shellby builtin cmd 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help - Displays info on the shellby builtin cmd 'help'.
 */
void help_help(void)
{
